package com.example.shreysindher.acm_alumni;
...
import com.example.shreysindher.acm_alumni.R;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hereTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(login_page.this, com.example.shreysindher.acm_alumni.Registration.class);
